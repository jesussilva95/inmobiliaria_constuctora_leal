          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h2 className="text-xl font-bold">InmobiliariaLeal</h2>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/inmobiliaria_constructoraleal/"
                target="_blank"
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-gray-300">
                    <p>Mz A - Casa 3 urb. Nohora Puyana </p>
                    <p>Norte de Santander, Colombia 12345</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm text-gray-300">
                    <p>Inmobiliaria&constructoraleal@outlook.com </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              © 2024 InmoLeal. Todos los derechos reservados.
            </div>
